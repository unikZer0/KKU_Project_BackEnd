<aside id="admin-sidebar" class="w-64 bg-white border-r min-h-screen md:sticky md:top-0">
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ route('admin.equipment')}}" class="flex items-center px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-50">Equipment</a>
        <a href="#" class="flex items-center px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-50">Requests</a>
        <a href="#" class="flex items-center px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-50">Users</a>
        <a href="#" class="flex items-center px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-50">Reports</a>
