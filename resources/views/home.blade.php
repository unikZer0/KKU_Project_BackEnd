                ...
                <div
                    ...
                    <div class="relative">
                        ...
                        @if ($equipment->status === 'maintenance')
                            <span
                                class="absolute top-2 right-2 bg-red-600 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded">
                                {{ ucfirst($equipment->status) }}
                            </span>
                        @elseif ($equipment->status === 'unavailable')
                            <span
                                class="absolute top-2 right-2 bg-gray-600 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded">
                                {{ ucfirst($equipment->status) }}
                            </span>
                        @else
                            <span
                                class="absolute top-2 right-2 bg-green-600 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded">
                                {{ ucfirst($equipment->status) }}
                            </span>
                        @endif
