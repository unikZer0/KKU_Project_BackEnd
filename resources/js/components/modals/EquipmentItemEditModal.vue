        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900">แก้ไขรายการอุปกรณ์</h3>
                ...
                <form @submit.prevent="handleSubmit" class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-3 rounded-md">
                        <h4 class="text-sm font-medium text-gray-700 mb-2">ข้อมูลเพิ่มเติม</h4>
                        <div class="text-xs text-gray-500 space-y-1">
                            <div>ID: {{ item.id }}</div>
                            <div>วันที่สร้าง: {{ formatDate(item.created_at) }}</div>
                            <div>วันที่อัปเดตล่าสุด: {{ formatDate(item.updated_at) }}</div>
                        </div>
                    </div>
