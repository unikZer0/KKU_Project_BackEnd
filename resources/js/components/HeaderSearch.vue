  ...
  <div class="w-full mb-5">
    <div class="flex items-center gap-3">
      ...
      <button
        type="button"
        @click="triggerSearch"
        class="bg-blue-600 hover:bg-blue-700 text-white font-medium px-5 py-3 rounded-lg flex items-center justify-center transition duration-200 whitespace-nowrap"
      >
